    ...
    macro_rules! func {
        ($fun:ident, $ret:ty, $($name:ident: $typ:ty),*) => {
            #[inline] pub unsafe fn $fun($($name: $typ),*) -> $ret {
                unsafe { transmute::<_, extern "system" fn($($typ),*) -> $ret>(storage::$fun.ptr.clone())($($name),*) }
            }
        }
    }
...
where
    F: FnMut(&'static CStr) -> *const c_void,
{
    storage::Accum.set_ptr(loadfn(c"glAccum"));
    storage::AlphaFunc.set_ptr(loadfn(c"glAlphaFunc"));
    storage::AreTexturesResident.set_ptr(loadfn(c"glAreTexturesResident"));
    storage::ArrayElement.set_ptr(loadfn(c"glArrayElement"));
    storage::Begin.set_ptr(loadfn(c"glBegin"));
    storage::BindTexture.set_ptr(loadfn(c"glBindTexture"));
    storage::Bitmap.set_ptr(loadfn(c"glBitmap"));
    storage::BlendFunc.set_ptr(loadfn(c"glBlendFunc"));
    storage::BufferStorageMemEXT.set_ptr(loadfn(c"glBufferStorageMemEXT"));
    storage::CallList.set_ptr(loadfn(c"glCallList"));
    storage::CallLists.set_ptr(loadfn(c"glCallLists"));
    storage::Clear.set_ptr(loadfn(c"glClear"));
    storage::ClearAccum.set_ptr(loadfn(c"glClearAccum"));
    storage::ClearColor.set_ptr(loadfn(c"glClearColor"));
    storage::ClearDepth.set_ptr(loadfn(c"glClearDepth"));
    storage::ClearIndex.set_ptr(loadfn(c"glClearIndex"));
    storage::ClearStencil.set_ptr(loadfn(c"glClearStencil"));
    storage::ClipPlane.set_ptr(loadfn(c"glClipPlane"));
    storage::Color3b.set_ptr(loadfn(c"glColor3b"));
    storage::Color3bv.set_ptr(loadfn(c"glColor3bv"));
    storage::Color3d.set_ptr(loadfn(c"glColor3d"));
    storage::Color3dv.set_ptr(loadfn(c"glColor3dv"));
    storage::Color3f.set_ptr(loadfn(c"glColor3f"));
    storage::Color3fv.set_ptr(loadfn(c"glColor3fv"));
    storage::Color3i.set_ptr(loadfn(c"glColor3i"));
    storage::Color3iv.set_ptr(loadfn(c"glColor3iv"));
    storage::Color3s.set_ptr(loadfn(c"glColor3s"));
    storage::Color3sv.set_ptr(loadfn(c"glColor3sv"));
    storage::Color3ub.set_ptr(loadfn(c"glColor3ub"));
    storage::Color3ubv.set_ptr(loadfn(c"glColor3ubv"));
    storage::Color3ui.set_ptr(loadfn(c"glColor3ui"));
    storage::Color3uiv.set_ptr(loadfn(c"glColor3uiv"));
    storage::Color3us.set_ptr(loadfn(c"glColor3us"));
    storage::Color3usv.set_ptr(loadfn(c"glColor3usv"));
    storage::Color4b.set_ptr(loadfn(c"glColor4b"));
    storage::Color4bv.set_ptr(loadfn(c"glColor4bv"));
    storage::Color4d.set_ptr(loadfn(c"glColor4d"));
    storage::Color4dv.set_ptr(loadfn(c"glColor4dv"));
    storage::Color4f.set_ptr(loadfn(c"glColor4f"));
    storage::Color4fv.set_ptr(loadfn(c"glColor4fv"));
    storage::Color4i.set_ptr(loadfn(c"glColor4i"));
    storage::Color4iv.set_ptr(loadfn(c"glColor4iv"));
    storage::Color4s.set_ptr(loadfn(c"glColor4s"));
    storage::Color4sv.set_ptr(loadfn(c"glColor4sv"));
    storage::Color4ub.set_ptr(loadfn(c"glColor4ub"));
    storage::Color4ubv.set_ptr(loadfn(c"glColor4ubv"));
    storage::Color4ui.set_ptr(loadfn(c"glColor4ui"));
    storage::Color4uiv.set_ptr(loadfn(c"glColor4uiv"));
    storage::Color4us.set_ptr(loadfn(c"glColor4us"));
    storage::Color4usv.set_ptr(loadfn(c"glColor4usv"));
    storage::ColorMask.set_ptr(loadfn(c"glColorMask"));
    storage::ColorMaterial.set_ptr(loadfn(c"glColorMaterial"));
    storage::ColorPointer.set_ptr(loadfn(c"glColorPointer"));
    storage::CopyPixels.set_ptr(loadfn(c"glCopyPixels"));
    storage::CopyTexImage1D.set_ptr(loadfn(c"glCopyTexImage1D"));
    storage::CopyTexImage2D.set_ptr(loadfn(c"glCopyTexImage2D"));
    storage::CopyTexSubImage1D.set_ptr(loadfn(c"glCopyTexSubImage1D"));
    storage::CopyTexSubImage2D.set_ptr(loadfn(c"glCopyTexSubImage2D"));
    storage::CreateMemoryObjectsEXT.set_ptr(loadfn(c"glCreateMemoryObjectsEXT"));
    storage::CullFace.set_ptr(loadfn(c"glCullFace"));
    storage::DeleteLists.set_ptr(loadfn(c"glDeleteLists"));
    storage::DeleteMemoryObjectsEXT.set_ptr(loadfn(c"glDeleteMemoryObjectsEXT"));
    storage::DeleteTextures.set_ptr(loadfn(c"glDeleteTextures"));
    storage::DepthFunc.set_ptr(loadfn(c"glDepthFunc"));
    storage::DepthMask.set_ptr(loadfn(c"glDepthMask"));
    storage::DepthRange.set_ptr(loadfn(c"glDepthRange"));
    storage::Disable.set_ptr(loadfn(c"glDisable"));
    storage::DisableClientState.set_ptr(loadfn(c"glDisableClientState"));
    storage::DrawArrays.set_ptr(loadfn(c"glDrawArrays"));
    storage::DrawBuffer.set_ptr(loadfn(c"glDrawBuffer"));
    storage::DrawElements.set_ptr(loadfn(c"glDrawElements"));
    storage::DrawPixels.set_ptr(loadfn(c"glDrawPixels"));
    storage::EdgeFlag.set_ptr(loadfn(c"glEdgeFlag"));
    storage::EdgeFlagPointer.set_ptr(loadfn(c"glEdgeFlagPointer"));
    storage::EdgeFlagv.set_ptr(loadfn(c"glEdgeFlagv"));
    storage::Enable.set_ptr(loadfn(c"glEnable"));
    storage::EnableClientState.set_ptr(loadfn(c"glEnableClientState"));
    storage::End.set_ptr(loadfn(c"glEnd"));
    storage::EndList.set_ptr(loadfn(c"glEndList"));
    storage::EvalCoord1d.set_ptr(loadfn(c"glEvalCoord1d"));
    storage::EvalCoord1dv.set_ptr(loadfn(c"glEvalCoord1dv"));
    storage::EvalCoord1f.set_ptr(loadfn(c"glEvalCoord1f"));
    storage::EvalCoord1fv.set_ptr(loadfn(c"glEvalCoord1fv"));
    storage::EvalCoord2d.set_ptr(loadfn(c"glEvalCoord2d"));
    storage::EvalCoord2dv.set_ptr(loadfn(c"glEvalCoord2dv"));
    storage::EvalCoord2f.set_ptr(loadfn(c"glEvalCoord2f"));
    storage::EvalCoord2fv.set_ptr(loadfn(c"glEvalCoord2fv"));
    storage::EvalMesh1.set_ptr(loadfn(c"glEvalMesh1"));
    storage::EvalMesh2.set_ptr(loadfn(c"glEvalMesh2"));
    storage::EvalPoint1.set_ptr(loadfn(c"glEvalPoint1"));
    storage::EvalPoint2.set_ptr(loadfn(c"glEvalPoint2"));
    storage::FeedbackBuffer.set_ptr(loadfn(c"glFeedbackBuffer"));
    storage::Finish.set_ptr(loadfn(c"glFinish"));
    storage::Flush.set_ptr(loadfn(c"glFlush"));
    storage::Fogf.set_ptr(loadfn(c"glFogf"));
    storage::Fogfv.set_ptr(loadfn(c"glFogfv"));
    storage::Fogi.set_ptr(loadfn(c"glFogi"));
    storage::Fogiv.set_ptr(loadfn(c"glFogiv"));
    storage::FrontFace.set_ptr(loadfn(c"glFrontFace"));
    storage::Frustum.set_ptr(loadfn(c"glFrustum"));
    storage::GenLists.set_ptr(loadfn(c"glGenLists"));
    storage::GenTextures.set_ptr(loadfn(c"glGenTextures"));
    storage::GetBooleanv.set_ptr(loadfn(c"glGetBooleanv"));
    storage::GetClipPlane.set_ptr(loadfn(c"glGetClipPlane"));
    storage::GetDoublev.set_ptr(loadfn(c"glGetDoublev"));
    storage::GetError.set_ptr(loadfn(c"glGetError"));
    storage::GetFloatv.set_ptr(loadfn(c"glGetFloatv"));
    storage::GetIntegerv.set_ptr(loadfn(c"glGetIntegerv"));
    storage::GetLightfv.set_ptr(loadfn(c"glGetLightfv"));
    storage::GetLightiv.set_ptr(loadfn(c"glGetLightiv"));
    storage::GetMapdv.set_ptr(loadfn(c"glGetMapdv"));
    storage::GetMapfv.set_ptr(loadfn(c"glGetMapfv"));
    storage::GetMapiv.set_ptr(loadfn(c"glGetMapiv"));
    storage::GetMaterialfv.set_ptr(loadfn(c"glGetMaterialfv"));
    storage::GetMaterialiv.set_ptr(loadfn(c"glGetMaterialiv"));
    storage::GetMemoryObjectParameterivEXT.set_ptr(loadfn(c"glGetMemoryObjectParameterivEXT"));
    storage::GetPixelMapfv.set_ptr(loadfn(c"glGetPixelMapfv"));
    storage::GetPixelMapuiv.set_ptr(loadfn(c"glGetPixelMapuiv"));
    storage::GetPixelMapusv.set_ptr(loadfn(c"glGetPixelMapusv"));
    storage::GetPointerv.set_ptr(loadfn(c"glGetPointerv"));
    storage::GetPolygonStipple.set_ptr(loadfn(c"glGetPolygonStipple"));
    storage::GetString.set_ptr(loadfn(c"glGetString"));
    storage::GetTexEnvfv.set_ptr(loadfn(c"glGetTexEnvfv"));
    storage::GetTexEnviv.set_ptr(loadfn(c"glGetTexEnviv"));
    storage::GetTexGendv.set_ptr(loadfn(c"glGetTexGendv"));
    storage::GetTexGenfv.set_ptr(loadfn(c"glGetTexGenfv"));
    storage::GetTexGeniv.set_ptr(loadfn(c"glGetTexGeniv"));
    storage::GetTexImage.set_ptr(loadfn(c"glGetTexImage"));
    storage::GetTexLevelParameterfv.set_ptr(loadfn(c"glGetTexLevelParameterfv"));
    storage::GetTexLevelParameteriv.set_ptr(loadfn(c"glGetTexLevelParameteriv"));
    storage::GetTexParameterfv.set_ptr(loadfn(c"glGetTexParameterfv"));
    storage::GetTexParameteriv.set_ptr(loadfn(c"glGetTexParameteriv"));
    storage::GetUnsignedBytei_vEXT.set_ptr(loadfn(c"glGetUnsignedBytei_vEXT"));
    storage::GetUnsignedBytevEXT.set_ptr(loadfn(c"glGetUnsignedBytevEXT"));
    storage::Hint.set_ptr(loadfn(c"glHint"));
    storage::ImportMemoryWin32HandleEXT.set_ptr(loadfn(c"glImportMemoryWin32HandleEXT"));
    storage::ImportMemoryWin32NameEXT.set_ptr(loadfn(c"glImportMemoryWin32NameEXT"));
    storage::IndexMask.set_ptr(loadfn(c"glIndexMask"));
    storage::IndexPointer.set_ptr(loadfn(c"glIndexPointer"));
    storage::Indexd.set_ptr(loadfn(c"glIndexd"));
    storage::Indexdv.set_ptr(loadfn(c"glIndexdv"));
    storage::Indexf.set_ptr(loadfn(c"glIndexf"));
    storage::Indexfv.set_ptr(loadfn(c"glIndexfv"));
    storage::Indexi.set_ptr(loadfn(c"glIndexi"));
    storage::Indexiv.set_ptr(loadfn(c"glIndexiv"));
    storage::Indexs.set_ptr(loadfn(c"glIndexs"));
    storage::Indexsv.set_ptr(loadfn(c"glIndexsv"));
    storage::Indexub.set_ptr(loadfn(c"glIndexub"));
    storage::Indexubv.set_ptr(loadfn(c"glIndexubv"));
    storage::InitNames.set_ptr(loadfn(c"glInitNames"));
    storage::InterleavedArrays.set_ptr(loadfn(c"glInterleavedArrays"));
    storage::IsEnabled.set_ptr(loadfn(c"glIsEnabled"));
    storage::IsList.set_ptr(loadfn(c"glIsList"));
    storage::IsMemoryObjectEXT.set_ptr(loadfn(c"glIsMemoryObjectEXT"));
    storage::IsTexture.set_ptr(loadfn(c"glIsTexture"));
    storage::LightModelf.set_ptr(loadfn(c"glLightModelf"));
    storage::LightModelfv.set_ptr(loadfn(c"glLightModelfv"));
    storage::LightModeli.set_ptr(loadfn(c"glLightModeli"));
    storage::LightModeliv.set_ptr(loadfn(c"glLightModeliv"));
    storage::Lightf.set_ptr(loadfn(c"glLightf"));
    storage::Lightfv.set_ptr(loadfn(c"glLightfv"));
    storage::Lighti.set_ptr(loadfn(c"glLighti"));
    storage::Lightiv.set_ptr(loadfn(c"glLightiv"));
    storage::LineStipple.set_ptr(loadfn(c"glLineStipple"));
    storage::LineWidth.set_ptr(loadfn(c"glLineWidth"));
    storage::ListBase.set_ptr(loadfn(c"glListBase"));
    storage::LoadIdentity.set_ptr(loadfn(c"glLoadIdentity"));
    storage::LoadMatrixd.set_ptr(loadfn(c"glLoadMatrixd"));
    storage::LoadMatrixf.set_ptr(loadfn(c"glLoadMatrixf"));
    storage::LoadName.set_ptr(loadfn(c"glLoadName"));
    storage::LogicOp.set_ptr(loadfn(c"glLogicOp"));
    storage::Map1d.set_ptr(loadfn(c"glMap1d"));
    storage::Map1f.set_ptr(loadfn(c"glMap1f"));
    storage::Map2d.set_ptr(loadfn(c"glMap2d"));
    storage::Map2f.set_ptr(loadfn(c"glMap2f"));
    storage::MapGrid1d.set_ptr(loadfn(c"glMapGrid1d"));
    storage::MapGrid1f.set_ptr(loadfn(c"glMapGrid1f"));
    storage::MapGrid2d.set_ptr(loadfn(c"glMapGrid2d"));
    storage::MapGrid2f.set_ptr(loadfn(c"glMapGrid2f"));
    storage::Materialf.set_ptr(loadfn(c"glMaterialf"));
    storage::Materialfv.set_ptr(loadfn(c"glMaterialfv"));
    storage::Materiali.set_ptr(loadfn(c"glMateriali"));
    storage::Materialiv.set_ptr(loadfn(c"glMaterialiv"));
    storage::MatrixMode.set_ptr(loadfn(c"glMatrixMode"));
    storage::MemoryObjectParameterivEXT.set_ptr(loadfn(c"glMemoryObjectParameterivEXT"));
    storage::MultMatrixd.set_ptr(loadfn(c"glMultMatrixd"));
    storage::MultMatrixf.set_ptr(loadfn(c"glMultMatrixf"));
    storage::NamedBufferStorageMemEXT.set_ptr(loadfn(c"glNamedBufferStorageMemEXT"));
    storage::NewList.set_ptr(loadfn(c"glNewList"));
    storage::Normal3b.set_ptr(loadfn(c"glNormal3b"));
    storage::Normal3bv.set_ptr(loadfn(c"glNormal3bv"));
    storage::Normal3d.set_ptr(loadfn(c"glNormal3d"));
    storage::Normal3dv.set_ptr(loadfn(c"glNormal3dv"));
    storage::Normal3f.set_ptr(loadfn(c"glNormal3f"));
    storage::Normal3fv.set_ptr(loadfn(c"glNormal3fv"));
    storage::Normal3i.set_ptr(loadfn(c"glNormal3i"));
    storage::Normal3iv.set_ptr(loadfn(c"glNormal3iv"));
    storage::Normal3s.set_ptr(loadfn(c"glNormal3s"));
    storage::Normal3sv.set_ptr(loadfn(c"glNormal3sv"));
    storage::NormalPointer.set_ptr(loadfn(c"glNormalPointer"));
    storage::Ortho.set_ptr(loadfn(c"glOrtho"));
    storage::PassThrough.set_ptr(loadfn(c"glPassThrough"));
    storage::PixelMapfv.set_ptr(loadfn(c"glPixelMapfv"));
    storage::PixelMapuiv.set_ptr(loadfn(c"glPixelMapuiv"));
    storage::PixelMapusv.set_ptr(loadfn(c"glPixelMapusv"));
    storage::PixelStoref.set_ptr(loadfn(c"glPixelStoref"));
    storage::PixelStorei.set_ptr(loadfn(c"glPixelStorei"));
    storage::PixelTransferf.set_ptr(loadfn(c"glPixelTransferf"));
    storage::PixelTransferi.set_ptr(loadfn(c"glPixelTransferi"));
    storage::PixelZoom.set_ptr(loadfn(c"glPixelZoom"));
    storage::PointSize.set_ptr(loadfn(c"glPointSize"));
    storage::PolygonMode.set_ptr(loadfn(c"glPolygonMode"));
    storage::PolygonOffset.set_ptr(loadfn(c"glPolygonOffset"));
    storage::PolygonStipple.set_ptr(loadfn(c"glPolygonStipple"));
    storage::PopAttrib.set_ptr(loadfn(c"glPopAttrib"));
    storage::PopClientAttrib.set_ptr(loadfn(c"glPopClientAttrib"));
    storage::PopMatrix.set_ptr(loadfn(c"glPopMatrix"));
    storage::PopName.set_ptr(loadfn(c"glPopName"));
    storage::PrioritizeTextures.set_ptr(loadfn(c"glPrioritizeTextures"));
    storage::PushAttrib.set_ptr(loadfn(c"glPushAttrib"));
    storage::PushClientAttrib.set_ptr(loadfn(c"glPushClientAttrib"));
    storage::PushMatrix.set_ptr(loadfn(c"glPushMatrix"));
    storage::PushName.set_ptr(loadfn(c"glPushName"));
    storage::RasterPos2d.set_ptr(loadfn(c"glRasterPos2d"));
    storage::RasterPos2dv.set_ptr(loadfn(c"glRasterPos2dv"));
    storage::RasterPos2f.set_ptr(loadfn(c"glRasterPos2f"));
    storage::RasterPos2fv.set_ptr(loadfn(c"glRasterPos2fv"));
    storage::RasterPos2i.set_ptr(loadfn(c"glRasterPos2i"));
    storage::RasterPos2iv.set_ptr(loadfn(c"glRasterPos2iv"));
    storage::RasterPos2s.set_ptr(loadfn(c"glRasterPos2s"));
    storage::RasterPos2sv.set_ptr(loadfn(c"glRasterPos2sv"));
    storage::RasterPos3d.set_ptr(loadfn(c"glRasterPos3d"));
    storage::RasterPos3dv.set_ptr(loadfn(c"glRasterPos3dv"));
    storage::RasterPos3f.set_ptr(loadfn(c"glRasterPos3f"));
    storage::RasterPos3fv.set_ptr(loadfn(c"glRasterPos3fv"));
    storage::RasterPos3i.set_ptr(loadfn(c"glRasterPos3i"));
    storage::RasterPos3iv.set_ptr(loadfn(c"glRasterPos3iv"));
    storage::RasterPos3s.set_ptr(loadfn(c"glRasterPos3s"));
    storage::RasterPos3sv.set_ptr(loadfn(c"glRasterPos3sv"));
    storage::RasterPos4d.set_ptr(loadfn(c"glRasterPos4d"));
    storage::RasterPos4dv.set_ptr(loadfn(c"glRasterPos4dv"));
    storage::RasterPos4f.set_ptr(loadfn(c"glRasterPos4f"));
    storage::RasterPos4fv.set_ptr(loadfn(c"glRasterPos4fv"));
    storage::RasterPos4i.set_ptr(loadfn(c"glRasterPos4i"));
    storage::RasterPos4iv.set_ptr(loadfn(c"glRasterPos4iv"));
    storage::RasterPos4s.set_ptr(loadfn(c"glRasterPos4s"));
    storage::RasterPos4sv.set_ptr(loadfn(c"glRasterPos4sv"));
    storage::ReadBuffer.set_ptr(loadfn(c"glReadBuffer"));
    storage::ReadPixels.set_ptr(loadfn(c"glReadPixels"));
    storage::Rectd.set_ptr(loadfn(c"glRectd"));
    storage::Rectdv.set_ptr(loadfn(c"glRectdv"));
    storage::Rectf.set_ptr(loadfn(c"glRectf"));
    storage::Rectfv.set_ptr(loadfn(c"glRectfv"));
    storage::Recti.set_ptr(loadfn(c"glRecti"));
    storage::Rectiv.set_ptr(loadfn(c"glRectiv"));
    storage::Rects.set_ptr(loadfn(c"glRects"));
    storage::Rectsv.set_ptr(loadfn(c"glRectsv"));
    storage::RenderMode.set_ptr(loadfn(c"glRenderMode"));
    storage::Rotated.set_ptr(loadfn(c"glRotated"));
    storage::Rotatef.set_ptr(loadfn(c"glRotatef"));
    storage::Scaled.set_ptr(loadfn(c"glScaled"));
    storage::Scalef.set_ptr(loadfn(c"glScalef"));
    storage::Scissor.set_ptr(loadfn(c"glScissor"));
    storage::SelectBuffer.set_ptr(loadfn(c"glSelectBuffer"));
    storage::ShadeModel.set_ptr(loadfn(c"glShadeModel"));
    storage::StencilFunc.set_ptr(loadfn(c"glStencilFunc"));
    storage::StencilMask.set_ptr(loadfn(c"glStencilMask"));
    storage::StencilOp.set_ptr(loadfn(c"glStencilOp"));
    storage::TexCoord1d.set_ptr(loadfn(c"glTexCoord1d"));
    storage::TexCoord1dv.set_ptr(loadfn(c"glTexCoord1dv"));
    storage::TexCoord1f.set_ptr(loadfn(c"glTexCoord1f"));
    storage::TexCoord1fv.set_ptr(loadfn(c"glTexCoord1fv"));
    storage::TexCoord1i.set_ptr(loadfn(c"glTexCoord1i"));
    storage::TexCoord1iv.set_ptr(loadfn(c"glTexCoord1iv"));
    storage::TexCoord1s.set_ptr(loadfn(c"glTexCoord1s"));
    storage::TexCoord1sv.set_ptr(loadfn(c"glTexCoord1sv"));
    storage::TexCoord2d.set_ptr(loadfn(c"glTexCoord2d"));
    storage::TexCoord2dv.set_ptr(loadfn(c"glTexCoord2dv"));
    storage::TexCoord2f.set_ptr(loadfn(c"glTexCoord2f"));
    storage::TexCoord2fv.set_ptr(loadfn(c"glTexCoord2fv"));
    storage::TexCoord2i.set_ptr(loadfn(c"glTexCoord2i"));
    storage::TexCoord2iv.set_ptr(loadfn(c"glTexCoord2iv"));
    storage::TexCoord2s.set_ptr(loadfn(c"glTexCoord2s"));
    storage::TexCoord2sv.set_ptr(loadfn(c"glTexCoord2sv"));
    storage::TexCoord3d.set_ptr(loadfn(c"glTexCoord3d"));
    storage::TexCoord3dv.set_ptr(loadfn(c"glTexCoord3dv"));
    storage::TexCoord3f.set_ptr(loadfn(c"glTexCoord3f"));
    storage::TexCoord3fv.set_ptr(loadfn(c"glTexCoord3fv"));
    storage::TexCoord3i.set_ptr(loadfn(c"glTexCoord3i"));
    storage::TexCoord3iv.set_ptr(loadfn(c"glTexCoord3iv"));
    storage::TexCoord3s.set_ptr(loadfn(c"glTexCoord3s"));
    storage::TexCoord3sv.set_ptr(loadfn(c"glTexCoord3sv"));
    storage::TexCoord4d.set_ptr(loadfn(c"glTexCoord4d"));
    storage::TexCoord4dv.set_ptr(loadfn(c"glTexCoord4dv"));
    storage::TexCoord4f.set_ptr(loadfn(c"glTexCoord4f"));
    storage::TexCoord4fv.set_ptr(loadfn(c"glTexCoord4fv"));
    storage::TexCoord4i.set_ptr(loadfn(c"glTexCoord4i"));
    storage::TexCoord4iv.set_ptr(loadfn(c"glTexCoord4iv"));
    storage::TexCoord4s.set_ptr(loadfn(c"glTexCoord4s"));
    storage::TexCoord4sv.set_ptr(loadfn(c"glTexCoord4sv"));
    storage::TexCoordPointer.set_ptr(loadfn(c"glTexCoordPointer"));
    storage::TexEnvf.set_ptr(loadfn(c"glTexEnvf"));
    storage::TexEnvfv.set_ptr(loadfn(c"glTexEnvfv"));
    storage::TexEnvi.set_ptr(loadfn(c"glTexEnvi"));
    storage::TexEnviv.set_ptr(loadfn(c"glTexEnviv"));
    storage::TexGend.set_ptr(loadfn(c"glTexGend"));
    storage::TexGendv.set_ptr(loadfn(c"glTexGendv"));
    storage::TexGenf.set_ptr(loadfn(c"glTexGenf"));
    storage::TexGenfv.set_ptr(loadfn(c"glTexGenfv"));
    storage::TexGeni.set_ptr(loadfn(c"glTexGeni"));
    storage::TexGeniv.set_ptr(loadfn(c"glTexGeniv"));
    storage::TexImage1D.set_ptr(loadfn(c"glTexImage1D"));
    storage::TexImage2D.set_ptr(loadfn(c"glTexImage2D"));
    storage::TexParameterf.set_ptr(loadfn(c"glTexParameterf"));
    storage::TexParameterfv.set_ptr(loadfn(c"glTexParameterfv"));
    storage::TexParameteri.set_ptr(loadfn(c"glTexParameteri"));
    storage::TexParameteriv.set_ptr(loadfn(c"glTexParameteriv"));
    storage::TexStorageMem1DEXT.set_ptr(loadfn(c"glTexStorageMem1DEXT"));
    storage::TexStorageMem2DEXT.set_ptr(loadfn(c"glTexStorageMem2DEXT"));
    storage::TexStorageMem2DMultisampleEXT.set_ptr(loadfn(c"glTexStorageMem2DMultisampleEXT"));
    storage::TexStorageMem3DEXT.set_ptr(loadfn(c"glTexStorageMem3DEXT"));
    storage::TexStorageMem3DMultisampleEXT.set_ptr(loadfn(c"glTexStorageMem3DMultisampleEXT"));
    storage::TexSubImage1D.set_ptr(loadfn(c"glTexSubImage1D"));
    storage::TexSubImage2D.set_ptr(loadfn(c"glTexSubImage2D"));
    storage::TextureStorageMem1DEXT.set_ptr(loadfn(c"glTextureStorageMem1DEXT"));
    storage::TextureStorageMem2DEXT.set_ptr(loadfn(c"glTextureStorageMem2DEXT"));
    storage::TextureStorageMem2DMultisampleEXT
        .set_ptr(loadfn(c"glTextureStorageMem2DMultisampleEXT"));
    storage::TextureStorageMem3DEXT.set_ptr(loadfn(c"glTextureStorageMem3DEXT"));
    storage::TextureStorageMem3DMultisampleEXT
        .set_ptr(loadfn(c"glTextureStorageMem3DMultisampleEXT"));
    storage::Translated.set_ptr(loadfn(c"glTranslated"));
    storage::Translatef.set_ptr(loadfn(c"glTranslatef"));
    storage::Vertex2d.set_ptr(loadfn(c"glVertex2d"));
    storage::Vertex2dv.set_ptr(loadfn(c"glVertex2dv"));
    storage::Vertex2f.set_ptr(loadfn(c"glVertex2f"));
    storage::Vertex2fv.set_ptr(loadfn(c"glVertex2fv"));
    storage::Vertex2i.set_ptr(loadfn(c"glVertex2i"));
    storage::Vertex2iv.set_ptr(loadfn(c"glVertex2iv"));
    storage::Vertex2s.set_ptr(loadfn(c"glVertex2s"));
    storage::Vertex2sv.set_ptr(loadfn(c"glVertex2sv"));
    storage::Vertex3d.set_ptr(loadfn(c"glVertex3d"));
    storage::Vertex3dv.set_ptr(loadfn(c"glVertex3dv"));
    storage::Vertex3f.set_ptr(loadfn(c"glVertex3f"));
    storage::Vertex3fv.set_ptr(loadfn(c"glVertex3fv"));
    storage::Vertex3i.set_ptr(loadfn(c"glVertex3i"));
    storage::Vertex3iv.set_ptr(loadfn(c"glVertex3iv"));
    storage::Vertex3s.set_ptr(loadfn(c"glVertex3s"));
    storage::Vertex3sv.set_ptr(loadfn(c"glVertex3sv"));
    storage::Vertex4d.set_ptr(loadfn(c"glVertex4d"));
    storage::Vertex4dv.set_ptr(loadfn(c"glVertex4dv"));
    storage::Vertex4f.set_ptr(loadfn(c"glVertex4f"));
    storage::Vertex4fv.set_ptr(loadfn(c"glVertex4fv"));
    storage::Vertex4i.set_ptr(loadfn(c"glVertex4i"));
    storage::Vertex4iv.set_ptr(loadfn(c"glVertex4iv"));
    storage::Vertex4s.set_ptr(loadfn(c"glVertex4s"));
    storage::Vertex4sv.set_ptr(loadfn(c"glVertex4sv"));
    storage::VertexPointer.set_ptr(loadfn(c"glVertexPointer"));
    storage::Viewport.set_ptr(loadfn(c"glViewport"));
}
